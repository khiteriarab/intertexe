...
export const FIBER_SYNONYMS: Record<string, string> = {
  ...
  '나일론': 'polyamide', '尼龙': 'polyamide', 'بوليامد': 'polyamide',
  ...
  'cânhamo': 'hemp', cañamo: 'hemp', canamo: 'hemp',
  ...
  // Ramie
  ramie: 'ramie', 'ramié': 'ramie', ramio: 'ramie',
