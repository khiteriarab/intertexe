-- =============================================================================
-- CANONICAL DEFINITION — catalog_taxonomy_browse_page
-- =============================================================================
-- DO NOT redefine this function inline in ad-hoc migrations.
-- Edit THIS FILE ONLY, then:
--   1. node scripts/guard-catalog-browse-speed.mjs
--   2. node scripts/apply-sql-via-mgmt-api.mjs lib/sql/catalog_taxonomy_browse_page.sql
--
-- Speed contract (non-negotiable):
--   • clothing/all + mappable leaves → catalog_browse_page_v2 (indexed, ~1–4s)
--   • Special slugs (sleepwear, matching-sets) → LIMIT/OFFSET page only
--   • NEVER: full card dedupe, COUNT(*) over entire filtered set before LIMIT
--
-- Regression reference: 20260829_catalog_taxonomy_browse_price_hotfix.sql overwrote
-- this with a slow path and broke iOS category browse (30s timeouts).
-- =============================================================================
