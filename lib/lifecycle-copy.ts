  ...
  switch (branch) {
    ...
    case LIFECYCLE_BRANCHES.DAY25_FEEDBACK:
      return {
        ...
        body: "We’d genuinely like to know what happened. Reply to this email with a photo or a short note — we read every response and use it to improve INTERTEXE.",
