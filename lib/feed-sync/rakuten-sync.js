...
function resolveAvailability(row) {
  ...
  // No explicit signal — do not assume in_stock; affiliate feeds often omit availability.
  // Listings stay live; stock_status stays honest until the next feed pass sets sold_out / in_stock.
  return { isAvailable: true, stockStatus: stockStatus || 'unknown' };
}
...
/** Tag null stock_status as unknown — never assume in_stock without feed evidence. */
