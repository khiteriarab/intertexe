...
- **Backend:** Express.js server in `server/` handles auth, favorites, quiz, AI scan endpoints (legacy, being migrated to Next.js API routes). Next.js API routes in `app/api/` handle designers, products, shop, sitemap, recommend.
