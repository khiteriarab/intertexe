...
- **Affiliate Integration:** Implements an interstitial `/leaving` page for affiliate redirects with disclosures. Rakuten Affiliate Network provides product feeds via FTP for 6 MIDs: Isabel Marant (49987), Fleur du Mal (50739), Faithfull the Brand (46961), Diesel (49384), A.L.C. (41993), and Marketplace MID 50745 (multi-brand outlet with 40 brands including Theory, Vince, rag & bone, L'Agence, FRAME, Rails, Paige, Free People, Johnny Was, etc.). Ingestion scripts: `scripts/ingest-fleur-du-mal.cjs`, `scripts/ingest-marketplace-50745.cjs`.
