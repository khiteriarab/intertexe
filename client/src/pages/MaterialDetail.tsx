...
const SEO_CONTENT: Record<string, { title: string; h1: string; intro: string; metaDesc: string }> = {
  silk: {
    ...
    metaDesc: "Shop the best silk dresses, silk tops, silk blouses and silk clothing in 2026. Every product verified for real silk content. Compare silk compositions across 40+ luxury and contemporary brands.",
  },
  cotton: {
    ...
    metaDesc: "Shop the best cotton clothing in 2026. Verified cotton dresses, cotton tops, cotton shirts and more. Compare cotton compositions across 40+ brands. No synthetic surprises.",
  },
  linen: {
    ...
    metaDesc: "Shop the best linen dresses, linen tops, linen pants and linen clothing in 2026. Every product verified for real linen/flax content across 40+ curated brands.",
  },
  wool: {
    ...
    metaDesc: "Shop the best wool sweaters, wool coats, merino wool clothing in 2026. Every product verified for real wool content. Compare compositions across 40+ brands.",
  },
  cashmere: {
