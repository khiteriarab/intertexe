...
const CURATED_BRAND_NAMES = new Set([
  ...
  "johnny was", "ramy brook", "nation ltd", "joe's jeans",
  "free people", "boss", "hugo boss", "trina turk",
  "alexia admor", "belle & bloom", "philipp plein",
  "sanctuary", "astr", "lafayette 148 new york", "lafayette 148",
  "bella dahl", "cece", "lilla p", "amanda uprichard",
  "cleobella", "marie oliver", "pj salvage", "nicole miller",
  "splendid", "something navy", "hutch", "anne klein",
  "heartloom", "hale bob", "pistola", "nic + zoe",
  "nydj", "j.mclaughlin", "elan",
]);
