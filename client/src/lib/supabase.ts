...
const WOMEN_FASHION_BRAND_SLUGS = new Set([
  ...
  "dissh", "tanya-taylor", "rebecca-taylor", "derek-lam",
  "rebecca-minkoff", "diesel", "isabel-marant", "grlfrnd",
]);
...
const NON_CLOTHING_PATTERNS = [
  ...
  /\be-gift card\b/i,
  /\bgift set\b/i,
  /\b(earring|necklace|bracelet|pendant|anklet|brooch|cufflink|charm necklace|choker)\b/i,
  /\bring\b.*\bby\b/i,
  /\b(signet ring|stacking ring|band ring|cocktail ring|statement ring)\b/i,
  /\b(phone strap|phone chain|phone charm|bag charm|bag strap)\b/i,
  /\bsunglasses\b/i,
  /\bcandle holder\b/i,
  /\bmesh tote\b/i,
  /\bcanvas tote\b/i,
