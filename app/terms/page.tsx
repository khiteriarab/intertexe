...
export const metadata: Metadata = {
  ...
  description: "INTERTEXE Terms of Service — the rules governing your use of our fashion discovery platform.",
  alternates: { canonical: "https://www.intertexe.com/terms" },
};
    ...
    <div className="py-8 md:py-16 max-w-3xl mx-auto w-full flex flex-col gap-10 md:gap-16">
      ...
      <div className="flex flex-col gap-8 md:gap-10 text-sm md:text-base text-foreground/80 leading-relaxed">
        <section className="flex flex-col gap-3">
          ...
          <p>
            By accessing and using Intertexe (&ldquo;the Platform&rdquo;), you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use the Platform.
          </p>
        </section>
