      ...
      <div className="container mx-auto px-4 md:px-8 py-10 md:py-20">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-6 md:gap-8">
          ...
          <div className="flex flex-col gap-3 md:gap-4">
            ...
            <Link href="/khiteri" className="text-sm text-background/70 hover:text-background transition-colors" data-testid="link-footer-khiteri">Khiteri&apos;s Edit</Link>
          ...
          <div className="flex flex-col gap-3 md:gap-4">
            ...
            <Link href="/rewards" className="text-sm text-background/70 hover:text-background transition-colors" data-testid="link-footer-rewards">Rewards</Link>
