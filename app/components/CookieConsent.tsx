...
export function CookieConsent() {
  ...
  return (
    <div
      className="fixed bottom-0 left-0 right-0 z-[60] bg-background border-t border-border/40 px-4 md:px-6 py-4 shadow-[0_-4px_24px_rgba(0,0,0,0.06)] mb-[calc(7.5rem+env(safe-area-inset-bottom,0px))] md:mb-0"
      role="dialog"
