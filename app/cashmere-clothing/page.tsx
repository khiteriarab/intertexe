...
export const metadata: Metadata = {
  ...
  description: "Shop verified cashmere clothing for women. Cashmere sweaters, cashmere cardigans, and cashmere knits — every product checked for genuine cashmere content.",
  alternates: { canonical: "https://www.intertexe.com/cashmere-clothing" },
};

export default async function CashmereClothingPage() {
  const [products, productCount] = await Promise.all([
    fetchProductsByFiberAndCategory("cashmere", undefined, 48),
    fetchProductCount(),
  ]);
    ...
    <div className="flex flex-col gap-0">
      <section className="py-10 md:py-16 text-center flex flex-col items-center gap-4 max-w-2xl mx-auto">
        <nav className="flex items-center gap-2 text-xs text-muted-foreground">
          ...
          <span>/</span><span className="text-foreground">Cashmere Clothing</span>
        </nav>
        <h1 className="text-3xl md:text-5xl font-serif">Cashmere Clothing</h1>
        <p className="text-sm md:text-base text-muted-foreground leading-relaxed max-w-lg">Cashmere is the pinnacle of luxury knitwear — three times more insulating than sheep wool, yet incredibly lightweight. But the market is flooded with blends that use as little as 5% cashmere. We checked every label.</p>
      ...
      <section className="flex flex-wrap gap-2 justify-center mb-8">
        {[{ path: "/materials/cashmere-sweaters", label: "Cashmere Sweaters" }, { path: "/materials/cashmere-knits", label: "Cashmere Cardigans" }].map(cat => (
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            <div className="flex flex-col gap-4">
              ...
              <ul className="flex flex-col gap-2"><li className="text-[13px] text-white/60">100% cashmere with 2-ply minimum for durability</li><li className="text-[13px] text-white/60">Grade A cashmere (14–15.5 microns) from Mongolia</li><li className="text-[13px] text-white/60">Dense, tight knit with no see-through spots</li><li className="text-[13px] text-white/60">Inner Mongolian or Scottish cashmere for the finest quality</li></ul>
            </div>
            <div className="flex flex-col gap-4">
              ...
              <ul className="flex flex-col gap-2"><li className="text-[13px] text-white/60">Cashmere blended with nylon or acrylic</li><li className="text-[13px] text-white/60">&quot;Cashmere-feel&quot; products — they&apos;re synthetic</li><li className="text-[13px] text-white/60">Single-ply cashmere — pills faster and wears thin</li></ul>
            </div>
            <div className="flex flex-col gap-4">
              ...
              <ul className="flex flex-col gap-2"><li className="text-[13px] text-white/60">Cashmere sweater under $100 — almost certainly low-grade or blended</li><li className="text-[13px] text-white/60">Scratchy hand-feel means coarse fibers (Grade C)</li><li className="text-[13px] text-white/60">&quot;Pashmina&quot; scarves under $80 — likely viscose</li></ul>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 md:py-16">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          {[{ path: "/linen-clothing", label: "Linen" }, { path: "/silk-clothing", label: "Silk" }, { path: "/cotton-clothing", label: "Cotton" }, { path: "/wool-clothing", label: "Wool" }].map(page => (
