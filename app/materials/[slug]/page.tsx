...
const SEO_CONTENT: Record<string, { title: string; h1: string; intro: string; metaDesc: string; tagline: string }> = {
  silk: {
    ...
    metaDesc: "Shop the best silk dresses, silk tops, silk blouses and silk clothing in 2026. Every product verified for real silk content. Compare silk compositions across curated luxury and contemporary brands.",
    tagline: "Luxurious drape, timeless",
  },
  cotton: {
    title: "Best Cotton Clothing 2026 — Verified Cotton Tops, Dresses & More",
    h1: "Shop Cotton Clothing",
    ...
    metaDesc: "Shop the best cotton clothing in 2026. Verified cotton dresses, cotton tops, cotton shirts and more. Compare cotton compositions across curated brands. No synthetic surprises.",
    tagline: "The foundation of every wardrobe",
  },
  linen: {
    title: "Best Linen Clothing 2026 — Verified Linen Dresses, Tops & More",
    h1: "Shop Linen Clothing",
    ...
    metaDesc: "Shop the best linen dresses, linen tops, linen pants and linen clothing in 2026. Every product verified for real linen/flax content across curated brands ranked by natural fiber quality.",
    tagline: "Light, airy, effortless",
  },
  wool: {
    title: "Best Wool Clothing 2026 — Verified Wool Sweaters, Coats & More",
    h1: "Shop Wool Clothing",
    ...
    metaDesc: "Shop the best wool sweaters, wool coats, merino wool clothing in 2026. Every product verified for real wool content. Compare compositions across curated brands.",
    tagline: "Warm, structured, seasonless",
  },
  cashmere: {
    title: "Best Cashmere Clothing 2026 — Verified Cashmere Sweaters & More",
    h1: "Shop Cashmere Clothing",
