...
const BRANDS_WITH_PRODUCTS: { slug: string; name: string; products: number }[] = [
  ...
  { slug: "faithfull-the-brand", name: "Faithfull the Brand", products: 595 },
  { slug: "isabel-marant", name: "Isabel Marant", products: 364 },
  { slug: "diesel", name: "Diesel", products: 243 },
  { slug: "ulla-johnson", name: "Ulla Johnson", products: 505 },
  { slug: "dl1961", name: "DL1961", products: 503 },
  { slug: "dissh", name: "Dissh", products: 499 },
  { slug: "fleur-du-mal", name: "Fleur du Mal", products: 217 },
  ...
  { slug: "a-l-c-", name: "A.L.C.", products: 4 },
