...
const VARIANT = {
  ...
  light: {
    trigger:
      "w-full flex items-center gap-2 text-left rounded-lg border border-[rgba(28,25,21,0.08)] bg-white px-3 py-2.5 hover:border-[rgba(196,165,116,0.35)] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[rgba(196,165,116,0.25)]",
    eyebrow: "text-[10px] tracking-[0.14em] uppercase text-[#9a948c]",
    value: "text-sm font-medium text-[#1c1915] truncate",
    chevron: "text-[#9a948c]",
    menu: "absolute z-[60] left-0 right-0 mt-1.5 overflow-hidden rounded-lg border border-[rgba(28,25,21,0.08)] bg-white shadow-[0_12px_40px_rgba(44,38,32,0.08)]",
    option: "w-full text-left px-3 py-2.5 text-sm text-[#6f6a63] hover:bg-[#f5f0e8] hover:text-[#1c1915] transition-colors",
    optionActive: "bg-[rgba(196,165,116,0.15)] text-[#2c2620] font-medium",
    error: "text-[#9e4a5a]",
  },
  rail: {
    trigger:
      "w-full flex items-center gap-2 text-left rounded-lg border border-[rgba(28,25,21,0.08)] bg-white px-3 py-2.5 hover:border-[rgba(196,165,116,0.35)] hover:shadow-[0_4px_16px_rgba(44,38,32,0.05)] transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-[rgba(196,165,116,0.25)]",
    eyebrow: "text-[10px] tracking-[0.14em] uppercase text-[#9a948c]",
    value: "text-sm font-medium text-[#1c1915] truncate",
    chevron: "text-[#9a948c]",
    menu: "absolute z-[60] left-0 right-0 mt-1.5 overflow-hidden rounded-lg border border-[rgba(28,25,21,0.08)] bg-white shadow-[0_16px_48px_rgba(44,38,32,0.08)]",
    option: "w-full text-left px-3 py-2.5 text-sm text-[#6f6a63] hover:bg-[#f5f0e8] hover:text-[#1c1915] transition-colors",
    optionActive: "bg-[rgba(196,165,116,0.15)] text-[#2c2620] font-medium",
    error: "text-[#9e4a5a]",
  },
  sidebar: {
    trigger:
      "w-full flex items-center gap-2 text-left rounded-lg border border-[rgba(28,25,21,0.08)] bg-white/70 px-3 py-2.5 text-[#2c2620] hover:bg-white hover:border-[rgba(196,165,116,0.35)] transition-colors",
    eyebrow: "text-[10px] tracking-[0.14em] uppercase text-[#9a948c]",
    value: "text-sm font-medium text-[#1c1915] truncate",
    chevron: "text-[#9a948c]",
    menu: "absolute z-[60] left-0 right-0 mt-1.5 overflow-hidden rounded-lg border border-[rgba(28,25,21,0.08)] bg-[#faf8f4] shadow-[0_12px_40px_rgba(44,38,32,0.1)]",
    option: "w-full text-left px-3 py-2.5 text-sm text-[#6f6a63] hover:bg-[#f5f0e8] hover:text-[#1c1915] transition-colors",
    optionActive: "bg-[rgba(196,165,116,0.18)] text-[#2c2620] font-medium",
    error: "text-[#9e4a5a]",
  },
} as const;
