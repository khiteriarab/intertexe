...
export const metadata: Metadata = {
  title: "Contact Us",
  description: "Get in touch with the INTERTEXE team. Submit a brand for review, update brand information, or reach out about press and partnerships.",
  alternates: { canonical: "https://www.intertexe.com/contact" },
};
