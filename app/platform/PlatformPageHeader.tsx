...
export function PlatformPageHeader({
  ...
  return (
    <section className="border-b border-[var(--platform-border)] bg-[var(--platform-bg)]">
      <div
        className={`max-w-6xl lg:max-w-[1280px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 pt-14 sm:pt-16 md:pt-20 pb-12 sm:pb-16 ${
