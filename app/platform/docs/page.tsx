...
export default function PlatformDocsPage() {
  ...
  -H "Authorization: Bearer itx_live_…"`}</pre>
        ...
        <h2 className="text-2xl font-light text-[#1a1a1a] mt-12 mb-3" style={{ fontFamily: "Georgia, serif" }}>GTIN formats</h2>
        <p>
        ...
        <h2 className="text-2xl font-light text-[#1a1a1a] mt-12 mb-3" style={{ fontFamily: "Georgia, serif" }}>Endpoints</h2>
        <p>
        ...
        <h2 className="text-2xl font-light text-[#1a1a1a] mt-12 mb-3" style={{ fontFamily: "Georgia, serif" }}>Match types</h2>
        ...
        <h2 className="text-2xl font-light text-[#1a1a1a] mt-12 mb-3" style={{ fontFamily: "Georgia, serif" }}>Evidence statuses</h2>
        ...
        <h2 className="text-2xl font-light text-[#1a1a1a] mt-12 mb-3" style={{ fontFamily: "Georgia, serif" }}>DPP alignment</h2>
        ...
        <h2 className="text-2xl font-light text-[#1a1a1a] mt-12 mb-3" style={{ fontFamily: "Georgia, serif" }}>Rate limits</h2>
        ...
        <h2 className="text-2xl font-light text-[#1a1a1a] mt-12 mb-3" style={{ fontFamily: "Georgia, serif" }}>Data freshness and versioning</h2>
        <p>
...
print(json.load(urllib.request.urlopen(url)))`}</pre>
        ...
        <h2 className="text-2xl font-light text-[#1a1a1a] mt-12 mb-3" style={{ fontFamily: "Georgia, serif" }}>Support</h2>
        <p>
          Early access:{" "}
