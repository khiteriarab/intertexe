      ...
      <div className="max-w-6xl lg:max-w-[1280px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 py-4 lg:py-5 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center justify-end gap-2 shrink-0">
          ...
          <Link
            ...
            className={
              dark
                ? "hidden md:inline-flex items-center gap-2 rounded-full bg-[var(--platform-surface)] px-4 py-2.5 text-[12px] font-medium text-[var(--platform-primary)] min-h-[40px] hover:bg-[var(--platform-highlight)] border border-[var(--platform-border)]"
                : "hidden md:inline-flex items-center gap-2 rounded-sm bg-[#111] px-4 sm:px-5 py-2.5 text-[12px] font-medium text-white min-h-[40px] hover:bg-black transition-colors"
            }
          >
