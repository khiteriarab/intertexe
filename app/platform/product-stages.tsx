            ...
            <div className="grid md:grid-cols-[1fr_280px] min-h-[340px]">
              ...
              <div className="bg-white border-t md:border-t-0 md:border-l border-[#e8e3da] flex flex-col max-h-[420px]">
                  ...
                  {MATCH_FILTERS.map((item) => (
                    <button
                      ...
                      className={`shrink-0 text-[10px] tracking-[0.06em] px-2.5 py-1.5 rounded-full border min-h-[32px] ${
                        filter === item
                          ? "bg-[var(--platform-primary)] text-white border-[var(--platform-primary)]"
                ...
                <div className="p-3 border-t border-[#eeeae4] space-y-2">
                  <p className="text-[11px] tracking-[0.08em] uppercase bg-[var(--platform-primary)] text-white text-center py-2">
    ...
    <figure className="m-0">
      <div className="flex items-end justify-center gap-3 sm:gap-6">
        ...
        <PhoneShell className="w-[210px] sm:w-[240px] z-10">
          <div className="bg-[var(--platform-primary)] text-white text-[9px] tracking-[0.08em] text-center py-1.5 px-2">
                ...
                >
                  <span
                    className={`mx-auto mb-1 block w-10 h-10 rounded-full border ${
                      material === item.id ? "border-[var(--platform-primary)]" : "border-[#e8e3da]"
                    }`}
            ...
            <div className="grid grid-cols-2 gap-2">
              {products.map((item) => (
                <div key={item.name}>
                  ...
                  <p className="text-[8px] tracking-[0.12em] uppercase text-[var(--platform-primary)]">{item.fiber}</p>
