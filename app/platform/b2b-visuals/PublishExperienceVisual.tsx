...
export function PublishExperienceVisual() {
  return (
    <PlatformGraphicOrFallback
      slot="actPassport"
      caption={`Publish screen from the enterprise workspace. Case study product: ${PASSPORT_CASE_STUDY.styleCode} · ${PASSPORT_CASE_STUDY.productName}. Configure, publish, and verify the consumer experience from the workspace.`}
      fallback={
