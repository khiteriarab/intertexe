    ...
    <PlatformChrome>
      <div className="max-w-sm mx-auto px-6 py-28 text-center">
        ...
        <p className="text-sm text-[#5c5854] leading-relaxed mb-10">
          Prospects request a 10-product snapshot or founding pilot. API keys are issued by INTERTEXE after
          qualification — there is no self-serve login for client keys yet. Operators use the private
          dashboard.
        </p>
        <Link
          href="/platform/request?intent=api_access&cta=login_page"
