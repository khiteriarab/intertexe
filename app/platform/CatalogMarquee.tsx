...
export function CatalogMarquee() {
  ...
  return (
    <section className="bg-[var(--platform-primary)] text-white py-12 sm:py-16 overflow-hidden">
      ...
      <div className="relative">
        <div className="pointer-events-none absolute inset-y-0 left-0 w-10 sm:w-16 bg-gradient-to-r from-[var(--platform-primary)] to-transparent z-10" />
        <div className="pointer-events-none absolute inset-y-0 right-0 w-10 sm:w-16 bg-gradient-to-l from-[var(--platform-primary)] to-transparent z-10" />
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8 mt-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
        ...
        <a
          href="/"
          className="inline-flex items-center justify-center text-[11px] tracking-[0.14em] uppercase border border-white/70 text-white px-7 py-3.5 hover:bg-white hover:text-[var(--platform-primary)] min-h-[44px]"
        >
