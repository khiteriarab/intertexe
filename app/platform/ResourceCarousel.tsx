...
const SURFACES = [
  {
    ...
    secondary: { href: "/brands/demo", label: "See how it works" },
  },
  {
    id: "iphone",
    tab: "iPhone app",
  ...
  },
  {
    ...
    primary: { href: "/brands/demo", label: "See the platform" },
    secondary: { href: "/brands/request?intent=snapshot", label: "See it with your products" },
  },
] as const;
