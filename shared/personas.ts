...
export const FABRIC_PERSONAS: FabricPersona[] = [
  {
    ...
    description:
      "You are drawn to the essence of what fabric can be at its most honest. Linen, cotton, silk, wool — nothing synthetic unless absolutely forced. You buy for quality, breathability, and long-term wear. You are the intellectual minimalist who reads care labels before price tags.",
  ...
  },
  {
    ...
    description:
      "You are moved by the way fabric falls, drapes, and catches light. Silk, satin, softness, femininity — luxury through emotion. You buy for flow, touch, and movement. Every piece you own tells a tactile story.",
  ...
  },
  {
    ...
    description:
      "You think in clean lines, sharp tailoring, and crisp construction. Structured wool blazers, cotton poplin shirts, tailored silhouettes that command a room. You buy for form, shape, and authority. Fabric is your building material.",
  ...
  },
  {
    ...
    description:
      "You believe beautiful clothes and ethical production are not mutually exclusive. Organic fibers, responsible sourcing, longevity over trend — you curate a wardrobe that reflects your values without compromising on style.",
  ...
  },
  {
    ...
    description:
      "You want stretch, durability, and wrinkle-resistance — but still elevated. Travel, work, movement: your wardrobe performs as hard as you do. You accept carefully blended fabrics when the result justifies it, as long as it never looks or feels cheap.",
...
export function assignPersona(quiz: {
  ...
  const hasStructure = mats.some(
    (m) => m.includes("wool") || m.includes("denim") || m.includes("leather") || m.includes("suede")
  );
  ...
  const hasNaturalOnly = mats.every(
    (m) =>
      m.includes("cotton") ||
      m.includes("silk") ||
      m.includes("linen") ||
