...
import { isAppDeepLinkReady, getAppStoreUrl } from "../lib/app-store.ts";
import {
  cohortWindowIso,
...
test("welcome CTA uses App Store while deep links are gated off", () => {
  assert.equal(isAppDeepLinkReady(), false);
